...
One possible hypothesis is that as time under starvation increases, HSP expressions decreases due to a lack of biomolecular resources, either energetic (e.g., ATP, Lipids) or monomeric (e.g., amino acids). Under such a hypothesis, the wide variance of UTLs as time under starvation increases can be explained as the variation in energetic reserves within a population.
