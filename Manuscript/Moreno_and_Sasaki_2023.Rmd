...
The acquisition of nutrition is a fundamental challenge for organisms. Environmental conditions have well-known effects on the ability to find, capture, and ingest food via the direct influence on organismal performance. Nutrition may also affect how environmental conditions impact organisms, however, by modifying the underlying sensitivity to changes in the experienced environment. In a changing climate, these feedbacks between feeding and sensitivity to environmental conditions are crucial to consider [@huey2019]. Anthropogenic climate change (and other human-driven disturbances) can impact marine ecosystems through longterm ocean warming and increased frequency of disturbances, such as marine heat waves (MHWs) [@johnston2022; @oliver2018; @hobday2016].

Temperature has strong effects on metabolic rates in ectothermic organisms, linking the energetic requirements to the thermal environment @johnston2022. We might therefore expect to see increasing consumption pressure on autotrophs and lower trophic levels as ocean warming proceeds, with consequences for community structure and the distribution of biomass [@archibald2022]. In addition to effects of long-term changes in temperature, acute warming events like marine heatwaves can threaten the stability of marine ecosystems by exposing marine organisms to temperatures beyond thermal optima [@smale2019; @harvey2022]. MHWs have increased in duration, intensity, and frequency over the last 4 decades [@li2022; @oliver2018]. The co-occurring nature of changes in food availability, community structure, and exposure to high temperature highlights the importance of studying interactions between organismal thermal limits and starvation.

These interactions, however, between starvation and thermal limits have been scantly studied in marine organisms. [NEED MORE HERE - quick summary of how starvation affects CTmax, pulling from both marine and non-marine taxa would be great]. Beyond the direct effects of starvation on thermal limits, @huey2019 describe a process termed 'metabolic meltdown', in which exposure to high temperatures, reduced food intake, and decreasing thermal limits act synergistically to drastically decrease tolerance to a warmer environment. A key component of metabolic meltdown is the reduction of thermal limits under reduced food intake. In order to better understand the vulnerability of marine systems to increasing temperatures, it is vital to determine how starvation affects thermal limits.
