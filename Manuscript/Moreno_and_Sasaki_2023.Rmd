...
Alternatively, as time under starvation increases HSP would be upregulated [@semsar-kazerouni2020, @nguyen2017], thus resulting in increased UTLs in starved versus fed individuals. under such a hypothesis, the increasing variance of UTLs with increased time under starvation can be understood to be the effects of unaccounted factors such as age.
