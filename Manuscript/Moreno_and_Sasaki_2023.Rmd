...
knitr::include_graphics("../Output/Figures/markdown/fig-1-1.png")
```
...
Our study reports that female *A. tonsa* copepods experienced a delayed response of UTLs to increasing time under starvation, similar to previous studies of sex-specific starvation tolerance in *A. tonsa* [@finiguerra2013]. Our results may indicate that female *A. tonsa* are generally more stress-tolerant than males, although an analysis of the sex-specific effects of starvation on UTLs is required. Furthermore, the increasing variance of UTLs with increasing time under starvation can be explained by a number of factors, including the age of copepods, and phenotypic plasticity of UTL and/or starvation tolerance.

Starvation tolerance in copepods is mediated by sex [@finiguerra2013], and species-specific energy reserves, specifically lipid stores [@hirahara2018]. The 3-day period until decreases in UTL are observed correlates to the 1-4 day period of egg production in starved *A. tonsa* females [@parrish1978]. Moreover increasing starvation period results in decreased respiration by female *A. tonsa* [@kiørboe1985], and is followed by elevated respiration (when compared to fed individuals) during recovery from starvation [@thor2003]. this pattern of reduced activity during starvation and rebounding once food is restored is similarly reflected in egg production rates [@kiørboe1985; @thor2003]. On the other hand, increased Heat Shock Protein (HSP) expression is linked to organismal responses to a wide array of environmental stressors [@sørensen2003]. However, the up-regulation of HSPs may ultimately be limited by nutritional resource availability.

One possible hypothesis is that as time under starvation increases, HSP expression decreases due to a lack of biomolecular resources, either energetic (e.g., ATP, Lipids) or monomeric (e.g., amino acids). Under such a hypothesis, the wide variance of UTLs as time under starvation increases can be explained as the variation in energetic reserves within a population. Alternatively, as time under starvation increases HSP would be upregulated [@semsar-kazerouni2020; @nguyen2017], thus resulting in increased UTLs in starved versus fed individuals. under such a hypothesis, the increasing variance of UTLs with increased time under starvation can be understood to be the effects of unaccounted factors such as age, or the deleterious impacts of previous stressors.

However, the present study does not provide sufficient evidence towards either hypothesis, due to the CT~max~ of individuals being derived from the point of ecological, rather than physiological, death. Even if the outward behavior of individuals is similar (failure to respond to stimuli), the physiological mechanisms for this failure may be completely different [@macmillan2019]. Thus, in order to ascertain the exact biomolecular pathway that leads to organismal failure at the UTL, experimentation that employs more physiologically relevant metrics (e.g. respirometry) is required.

Alternatively, as time under starvation increases HSP would be upregulated [@semsar-kazerouni2020; @nguyen2017], thus resulting in increased UTLs in starved versus fed individuals. under such a hypothesis, the increasing variance of UTLs with increased time under starvation can be understood to be the effects of unaccounted factors such as age, or the deleterious impacts of previous stressors.

The results present a dire situation for copepod populations, in the face of both short- and long- term temperature increases associated with Anthropogenic Climate Change. Although research on large-scale changes in phytoplankton populations due to temperature increases lack consensus [@boyce2010; @archibald2022; @taucher2011], the decrease in vertical mixing associated with the intensified thermal stratification will select for smaller motile phytoplankter [@winder2012]. Furthermore, increased abundances of heterotrophs in relation to autotrophs may compound and further threaten the food supply for mesoplankter like *A. tonsa*, which prefers to feed on medium sized phytoplankton [citation needed?].

On the other hand, the wide variability in CT~max~ as starvation period increased have indicated that the tolerance to simultaneous starvation and extreme heat have a wide range of phenotypic plasticity. However, copepods would also have to contend with shifts in the phenology of the spring bloom (shifting to earlier in the year), and generally less available phytoplankton biomass [@sommer2008]. Moreover, summers would be plagued by both starvation (due to the stratification of nutrients along the thermocline) and heat extremes. Furthermore, our experiments show the higher end of *A. tonsa* UTLs, since males have generally lower CT~max~ values than females [@finiguerra2013].

Developing an understanding of how changing environmental factors affect the thermal performance of mesozooplankter generally (and *A. tonsa* specifically) is crucial due to their role as the trophic interface between plankton and larger aquatic food webs [citation needed?]. Moreover, *A. tonsa* is specifically fascinating as a model system to study phenotypic plasticity, partly due to their ability to tolerate a wide range natural and anthropogenic stressors, resulting in them invading temperature and subtropical estuaries through anthropogenic introduction [@aravena2009; @svetlichny2014].
