...
These interactions, however, between starvation and thermal limits have been scantly studied, especially in aquatic ectotherms. Most experiments which examine this relationship have focused on terrestrial taxa, including Diptera [@manenti2018; @gotcha2018; @mitchell2017], Coleoptera [@chidawanyika2017; @scharf2016], Hymenoptera [@nguyen2017, @gonzalez2022], Hempitera [@devries2016], and Lepidotera [@mutamiswa2018, @mir2018].These studies vary in methodology and results, but generally indicate that organismal responses to starvation and heat tolerance are closely related. Moreover, Experiments on the freshwater amphipod *Gammarus fossarum* revealed that starvation improved survival during acute heat stress, but had no effect on mild heat stress [@semsar-kazerouni2020]. Beyond the direct effects of starvation on thermal limits, @huey2019 describes a process termed 'metabolic meltdown', in which exposure to high temperatures, reduced food intake, and decreasing thermal limits act synergistically to drastically decrease tolerance to a warmer environment. A key component of metabolic meltdown is the reduction of thermal limits under reduced food intake. In order to better understand the vulnerability of marine systems to increasing temperatures, it is vital to determine how starvation affects thermal limits.
