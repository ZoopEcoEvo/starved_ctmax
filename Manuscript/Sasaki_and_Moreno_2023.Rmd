...
Long term increases in ocean temperatures can accelerate the metabolisms of marine organisms, due to the fact that most are ectothermic, linking the rates of their metabolic processes to their thermal environment @johnston2022. As a result, caloric requirements will increase, increasing consumption pressure on autotrophic organisms. Modeling of community-scale metabolism reveals that increases in ocean temperature could result in increased NPP and decreases in total community biomass while community structure shifted to increased heterotrophic biomass relative to autotrophic biomass @archibald2022 . although the precise changes in community structure were heavily dependent on region, the aforementioned changes could result in greater intra- and inter- specific competition, and overall result in the top-down control of prey populations by predators. Furthermore, The reduction in dissolved oxygen associated with increased ocean temperatures further exacerbates resource limitations imposed by increased metabolic requirements and changes in marine community structure. Moreover, according to the 'evolutionary speed' hypothesis, the processes of speciation and adaptive evolution could be hastened, due to the increase in mutation rate and shorter generation times associated with increases in environmental temperature. @johnston2022. (last sentence may be tangential. thoughts?)

On the other hand, MHWs threaten the stability of marine ecosystems by exposing marine organisms to temperatures beyond their optimum and into the lethal range. [more MHWs literature, lead into next parragraph with brief intro to CTmax]

[Summary of starvation effects on thermal limits literature; introduction to metabolic meltdown]. It is vital to understand how copepod thermal limits respond to changes in food availability in order to better model population dynamics in a changing climate.
